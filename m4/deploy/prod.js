...
(function(){
    ...
    __m.bootstrap = {
        ...
        initialize: function () {
            ...
            require(['widgets.summaryForm.js', 'summaryForm.css'], function () {
                __widgets.map = new __widgets.SummaryForm();
            });
     ...
     */
    var BlankModel = Backbone.Model.extend({
        
        /**
         * Geocoded locations from the application user
         * @param
         */
        locations: []
    ...
    /*
    model.bind('change:locations', function(model, color) {
        m4.nodes.pane.css({
            background: color 
        });
    });
